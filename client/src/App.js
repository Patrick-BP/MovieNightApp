              ...
              <div className="discover__content">
                <div class="discover__left">
                  ...
                  <div class="button__box">
                    ...
                    <button class="btn2">My List</button>
                  </div>
                  <p>
        ...
        <div className="right-side ">
          ...
          <div>
           <span className="p-3">Popular Movies</span> 
            ...
            <a href="/movie/760741"><div className="popularMovies"><div className="banner__img"><img src="https://image.tmdb.org/t/p/original/1n7ZGr6WeDOW4rFiQKmFel8baWH.jpg" alt="Beast"/></div><div className="popular__content"><span>Beast</span><p>A recently widowed man and his two teenage daughters travel to a game reserve in South Af...</p></div></div></a>
