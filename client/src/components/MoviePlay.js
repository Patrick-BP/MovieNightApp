...
function MoviePlay() {
  ...
  useEffect(() => {
    (async function fetch() {
      const findbyId = await axios.get(`/movies/${movieId.movieId}`);
      setMovieInfo(findbyId.data);
    })();
  }, []);
  const month = new Date(movieInfo.releaseDate);
    ...
    <>
      <div>
        ...
        <div className="video-overview">
          <div onClick={()=>addtolistFun(movieInfo._id)} className="tag btn btn-outline-secondary">
          ...
          <div className="d-flex">
            <div className="left-img ">
              <img src={`/movie-img/${movieInfo.smallimg}`} alt="movie" />
            </div>
